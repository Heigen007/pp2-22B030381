...
pause = pygame.image.load(
    r'images\Pause-PNG-Image-Transparent.png')
start = pygame.image.load(
    r'images\Play-Button-Transparent-Image.png')
...
while check:
    ...
    sc.blit(sp, (750, -5))
    [(pg.draw.rect(sc, pg.Color("white"), (i, j, 20, 20))) for i, j in snake_body]
    pg.draw.rect(sc, pg.Color("red"), (*apple, size_full_apple_x, size_full_apple_y))
